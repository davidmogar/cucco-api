...
class TestLimits(TestCase):
    ...
    def test_accents_limit(self):
        self._test_rate_limit('/v1/accents?text=foo', 30)

    def test_characters_limit(self):
        self._test_rate_limit('/v1/characters?text=foo', 30)

    def test_emails_limit(self):
        self._test_rate_limit('/v1/emails?text=foo', 30)

    def test_emojis_limit(self):
        self._test_rate_limit('/v1/emojis?text=foo', 30)

    def test_hyphens_limit(self):
        self._test_rate_limit('/v1/hyphens?text=foo', 30)

    def test_normalize_limit(self):
        self._test_rate_limit('/v1/normalize?text=foo', 10)

    def test_punctuation_limit(self):
        self._test_rate_limit('/v1/punctuation?text=foo', 30)

    def test_stopwords_limit(self):
        self._test_rate_limit('/v1/stopwords?text=foo', 10)

    def test_symbols_limit(self):
        self._test_rate_limit('/v1/symbols?text=foo', 30)

    def test_urls_limit(self):
        self._test_rate_limit('/v1/urls?text=foo', 30)

    def test_whitespaces_limit(self):
        self._test_rate_limit('/v1/whitespaces?text=foo', 30)
